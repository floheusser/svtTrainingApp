<script>
    ...
    import MyAppointmentAccordion from "../components/CustomerMyAppointmentAccordion.svelte";
                    ...
                    <div class="card rounded-3">
                        <div class="card-body p-4">
                            ...
                            {#each myRequestedAppointments as appointment}
                                <MyAppointmentAccordion appointment={appointment} hairdressers={hairdressers} hairdresserTasks={hairdresserTasks} listTypeRequest={true}/>
                            {/each}
                            </div>
                            {:else}
                    ...
                    <div class="card rounded-3">
                        <div class="card-body p-4">
                            ...
                            {#each myApprovedAppointments as appointment}
                                <MyAppointmentAccordion appointment={appointment} hairdressers={hairdressers} hairdresserTasks={hairdresserTasks} listTypeRequest={false}/>
                            {/each}
                            </div>
                            {:else}
                            <h6 class="text-center my-3 pb-3" style="color: red;">Keine bevorstehenden Termine</h6>
